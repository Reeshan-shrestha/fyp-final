      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="md:flex md:justify-between">
          <div className="mb-8 md:mb-0">
            ...
            <p className="text-gray-500 mt-2 max-w-md">
              A blockchain-powered marketplace providing secure and transparent transactions for buyers and sellers.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-8 md:gap-16">
            <div>
              ...
              <ul className="mt-4 space-y-4">
                ...
                <li><Link href="/status" className="text-base text-gray-500 hover:text-gray-900">API Status</Link></li>
              </ul>
            </div>
            <div>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
            &copy; 2024 ChainBazzar. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
